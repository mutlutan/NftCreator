...
namespace WebApp1.Areas.CodeGen.Models
{
    public class MyTableOption
    {
        ...
        public string DataTransferObjectNameName { get; set; } = "";
        public string DataTransferObjectNameSpace { get; set; } = "";

        public string DataManipulationObjectName { get; set; } = "";
        public string DataManipulationObjectNameName { get; set; } = "";
        public string DataManipulationObjectNameSpace { get; set; } = "";

        public string RepositoryName { get; set; } = "";
        public string RepositoryNameName { get; set; } = "";
        public string RepositoryNameSpace { get; set; } = "";

        public string ControllerName { get; set; } = "";
        public string ControllerNameName { get; set; } = "";
        ...
        public string SearchViewShowType { get; set; } = ""; //Page, Popup
