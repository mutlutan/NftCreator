...
{
    public partial class DtoTemKullaniciAbonelik : TemKullaniciAbonelik
    {
        protected readonly DataContext dataContext;

        public string CcKullaniciIdAd{ get; set; }
        public string CcAbonelikDurumIdAd{ get; set; }
        public string CcAbonelikUrunPlanIdAd{ get; set; }
        ...
        //Constructor
        public DtoTemKullaniciAbonelik(DataContext dataContext)
        {
