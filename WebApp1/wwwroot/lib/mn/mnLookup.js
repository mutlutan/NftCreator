...
window.mnLookup = function () {
    ...
    self.listLoad = function (_opt) {
        ...
        var _dsName = opt.TableName + opt.TextField;
        ...
        if (self.list.get(_dsName) !== undefined) {
            ...
            //    },
            //    error: function (e) {
            //        console.log("listLoad",e);
            //        if (e.xhr === null) { alert(e.errors); }
            //        else { mnErrorHandler.Handle(e.xhr);}
            //    }
            //});
    ...
    self.prepare = function () {
        ...
        if (self.list === null) {
            self.list = kendo.observable({
                ...
                //...
                dsUlkeSehirIlce: new kendo.data.DataSource({
                    transport: {
                        read: {
                            type: "POST", dataType: "json",
                            url: "/Lookup/ReadUlkeSehirIlce"
                        }
                    },
                    schema: {
                        errors: 'Errors', data: 'Data', total: 'Total', aggregates: 'Aggregates'
                ...
                dsEnmSahipTurForDescription: new kendo.data.DataSource({
                    transport: {
                        read: {
                            type: "POST", dataType: "json",
                            url: "/Lookup/ReadEnmSahipTurForDescription"
                        }
                    },
                    schema: {
                        errors: 'Errors', data: 'Data', total: 'Total', aggregates: 'Aggregates',
                ...
                //...
                dsKullaniciSahip: new kendo.data.DataSource({
                    transport: {
                        read: {
                            type: "POST", dataType: "json",
                            url: "/Lookup/ReadKullaniciSahip"
                        }
                    },
                    schema: {
                        errors: 'Errors', data: 'Data', total: 'Total', aggregates: 'Aggregates'
        ...
        self.list.dsUlkeSehirIlce.read();
        self.list.dsKullaniciSahip.read();

        //önyüklemeli olanlar ve kullanım şekli
        self.listLoad({
            TableName: 'TemParaBirim',
            ValueField: "Id",
            TextField: 'Simge',
            OtherFields: '',
            Filters: [
