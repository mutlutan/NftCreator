    ...
    public class AccountController : _Controller
    {
        ...
        public ActionResult GetUserInfo()
        {
            ...
            return Json(new
            {
                ...
                bAdmin = (this.userToken.KullaniciSahipTur == EnmSahipTur.Admin),
                ...
                sKullaniciSahipTur = this.userToken.KullaniciSahipTur.ToString(),
                nYetkiGrup = (int)this.userToken.KullaniciSahipTur,
                nSahipId = this.userToken.KullaniciSahipId,
